    ...
    <table class="min-w-full bg-white border border-gray-300">
      <thead>
        <tr class="border-b border-gray-300">
          <th
            class="w-1/5 px-4 py-2 text-left text-sm font-semibold border-r border-gray-300 cursor-pointer"
          ...
          <th
            class="w-1/5 px-4 py-2 text-left text-sm font-semibold cursor-pointer"
